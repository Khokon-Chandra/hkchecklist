        ...
        <div class="flex flex-col gap-3 mb-4">
            <div class="flex items-center justify-between gap-3">
                ...
                <div class="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
                    <span
                        class="inline-flex items-center gap-1 px-2 py-1 rounded-full bg-indigo-50 text-indigo-700 dark:bg-indigo-900/40 dark:text-indigo-200">
                        <span class="w-1.5 h-1.5 rounded-full bg-indigo-500"></span>
                        <span x-text="rooms.length + ' rooms'"></span>
                    </span>
                    <span
                        class="inline-flex items-center gap-1 px-2 py-1 rounded-full bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-300">
                        Selected:
                        <span class="font-semibold" x-text="selectedIds.length"></span>
                    </span>
                </div>
            </div>
            ...
            <div class="flex items-center justify-between text-xs text-gray-500 dark:text-gray-400">
                ...
                <span x-show="search" x-text="'Filtered: ' + filtered.length" class="italic"></span>
            </div>
        </div>
                        ...
                        <div class="min-w-0">
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400 flex items-center gap-2">
                                <span x-show="room.is_default"
                                    class="inline-flex items-center gap-1 px-1.5 py-0.5 rounded-full bg-emerald-50 text-emerald-700 dark:bg-emerald-900/40 dark:text-emerald-200">
