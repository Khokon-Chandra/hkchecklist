...
@if ($logoPath && \Illuminate\Support\Facades\Storage::disk('public')->exists($logoPath))
    {{-- Custom Logo --}}
    <img {{ $attributes->merge(['alt' => config('app.name', 'HK Checklist')]) }}
...
@else
    ...
    <svg {{ $attributes }} xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24">
        <g fill="none" stroke="{{ $themeColor }}" stroke-width="1.5">
            ...
            <path stroke-linecap="round"
                d="M13 9h-2M9.5 19v-4m5 4v-4M19 5c0-1.414 0-2.121-.44-2.56C18.122 2 17.415 2 16 2H8c-1.414 0-2.121 0-2.56.44C5 2.878 5 3.585 5 5m0 7v7h14v-7" />
        </g>
    </svg>
@endif
